...
const TeamModal = ({ handleCloseModal, teamId }) => {
  ...
  return (
    <div className="z-100 flex justify-center items-center fixed inset-0 bg-black bg-opacity-50">
        ...
        <div className="flex flex-row p-3 gap-3">
          <div className="flex flex-col gap-3 w-full md:w-1/2">
            ...
            <div className="dark:bg-dark-bg bg-white flex flex-col items-center text-center p-3 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-[80%] mx-auto">
                {drivers.map(driver => (
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="w-full h-full overflow-hidden rounded-t-md flex items-center justify-center bg-gray-300 text-gray-700 text-4xl font-righteous">
              {team.image ? (
                <img
                  src={team.image}
