    ...
    return (
        <div className="z-100 flex justify-center items-center fixed">
            <div className="relative max-w-5xl w-full max-h-[90vh] bg-[#35476b] rounded-2xl overflow-hidden border-2 border-black">
                <div className="relative flex items-center justify-between bg-[#2a2a2a] text-white px-4 py-2">
                    <img
                        className="w-24 h-18 rounded-tl-2xl border-2 border-[#2a2a2a]"
                        src="https://placehold.co/108x72"
                        alt="Driver"
                    />
                    <h2 className="text-3xl">Max Verstappen</h2>
                    <button onClick={handleCloseModal} className="text-3xl p-4 hover:cursor-pointer">x</button>
                </div>
